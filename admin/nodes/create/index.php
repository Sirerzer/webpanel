        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="form-label">Node usings</label>
                        <div>
                            <div class="radio radio-success radio-inline">

                                <input type="radio" id="pPublicTrue" value="1" name="public" checked="">
                                <label for="pPublicTrue"> Classique </label>
                            </div>
                            <div class="radio radio-danger radio-inline">
                                <input type="radio" id="pPublicFalse" value="0" name="public">
                                <label for="pPublicFalse"> Proxy </label>
                            </div>
                            <div class="radio radio-danger radio-inline">
                                <input type="radio" id="pPublicFalse" value="0" name="public">
                                <label for="pPublicFalse"> Classique Node and Proxy </label>
                            </div>
                        </div>
                        <p class="text-muted small">If you have one serveur using <code> Classique Node and Proxy </code>.
                    </p></div>
