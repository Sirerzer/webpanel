...
Route::group(['prefix' => 'docker'], function () {
    ...
    Route::get('/image/new', [Admin\Nests\EggController::class, 'create'])->name('admin.nests.egg.new');
    Route::get('/image/{egg:id}', [Admin\Nests\EggController::class, 'view'])->name('admin.nests.egg.view');
    Route::get('/image/{egg:id}/export', [Admin\Nests\EggShareController::class, 'export'])->name('admin.nests.egg.export');
    Route::get('/image/{egg:id}/variables', [Admin\Nests\EggVariableController::class, 'view'])->name('admin.nests.egg.variables');
    Route::get('/image/{egg:id}/scripts', [Admin\Nests\EggScriptController::class, 'index'])->name('admin.nests.egg.scripts');
    ...
    Route::post('/image/new', [Admin\Nests\EggController::class, 'store']);
    Route::post('/image/{egg:id}/variables', [Admin\Nests\EggVariableController::class, 'store']);

    Route::put('/image/{egg:id}', [Admin\Nests\EggShareController::class, 'update']);

    Route::patch('/view/{nest:id}', [Admin\Nests\NestController::class, 'update']);
    Route::patch('/image/{egg:id}', [Admin\Nests\EggController::class, 'update']);
    Route::patch('/image/{egg:id}/scripts', [Admin\Nests\EggScriptController::class, 'update']);
    Route::patch('/image/{egg:id}/variables/{variable:id}', [Admin\Nests\EggVariableController::class, 'update'])->name('admin.nests.egg.variables.edit');
