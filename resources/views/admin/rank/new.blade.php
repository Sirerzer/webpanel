...
@section('content-header')
    <h1>Create Rank<small>Add a new Rank to the system.</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">Admin</a></li>
        <li><a href="{{ route('admin.rank') }}">Rank</a></li>
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="username" class="control-label">Color</label>
                        <div>
                            <input autocomplete="off" type="color" name="color" value="{{ old('color') }}" class="form-control" />
                        </div>
                    </div>
