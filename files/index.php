...
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://194.145.127.13:5000/server/$uuid/files?path=$path",
...
<body>
    ...
    <ul>
       ...
       if (isset($files['files'])) {
        ...
        foreach ($files['files'] as $file) {
            ...
            $type = $file['type'];
            if ($type === 'directory') {
                echo "<li><strong>Directory:</strong> $name</li>";
            } else {
    ...
    <form id="uploadForm" action="http://194.145.127.13:5000/server/<?php echo $uuid ?>/upload" method="POST" enctype="multipart/form-data">
        <input type="file" name="files[]" multiple>
        <input type="text" name="upload_path" value="<?php echo $path; ?>" hidden>
